...
{
    public partial class frm_OgrenciOgretmenMail : Form
    {
        public frm_OgrenciOgretmenMail()
        {
            InitializeComponent();
        }
        ...
        private void btnGonder_Click(object sender, EventArgs e)
        {
            ...
            sc.Credentials = new System.Net.NetworkCredential(frm_OgrenciMailEkrani.velimail, frm_OgrenciMailEkrani.velimailsifre);
            sc.Port = 587;
            sc.Host = " smtp.gmail.com";
            sc.EnableSsl = true;
            mail.From = new MailAddress(frm_OgrenciMailEkrani.velimail);
        ...
        private void frm_OgrenciOgretmenMail_Load(object sender, EventArgs e)
        {
            listele();
        }
    }
