...
{
    public partial class frm_ogretmenveliMailgonder : Form
    {
        public frm_ogretmenveliMailgonder()
        {
            InitializeComponent();
        }
        ...
        {
            lst_veli_mail.Items.Add(dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString());
        }

        private void frm_ogretmenveliMailgonder_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void btnGonder_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < lst_veli_mail.Items.Count; i++)
            {
                mail.To.Add(lst_veli_mail.Items[i].ToString());
            }
        ...
        {
            int secim = lst_veli_mail.SelectedIndex;
            if (secim != -1)
            {
                lst_veli_mail.Items.RemoveAt(secim);
            }
            else
            {
